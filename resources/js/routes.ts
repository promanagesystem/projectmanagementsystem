...
const Ziggy = {
    ...
    routes: {
        ...
        'activity-logs.show': {
            uri: 'activity-logs/{activity_log}',
            methods: ['GET', 'HEAD'],
        },
        'my-tasks.index': { uri: 'my-tasks', methods: ['GET', 'HEAD'] },
        'projects.tasks.attachments': {
            uri: 'projects/{project}/tasks/{task}/attachments',
            methods: ['GET', 'HEAD'],
        },
        'attachments.store': { uri: 'attachments', methods: ['POST'] },
        'attachments.destroy': {
        ...
        // "attachments.project.destroy": { uri: "projects/{project}/attachments/{attachment}", methods: ["DELETE"] },

        'projects.sprints.tasks.subtasks.index': {
...
console.log('Ziggy loaded from routes.ts');
export { Ziggy };
