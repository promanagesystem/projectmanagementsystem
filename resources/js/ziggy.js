const Ziggy = {
    ...
    routes: {
        ...
        'projects.details.create': {
            uri: 'projects\/{project}\/details\/create',
            methods: ['GET', 'HEAD'],
            parameters: ['project'],
            bindings: { project: 'id' },
        },
        'projects.details.store': {
            uri: 'projects\/{project}\/details',
            methods: ['POST'],
            parameters: ['project'],
            bindings: { project: 'id' },
        },
        ...
        'projects.details.edit': {
            uri: 'projects\/{project}\/details\/edit',
            methods: ['GET', 'HEAD'],
            parameters: ['project'],
            bindings: { project: 'id' },
        },
        'projects.details.update': {
            uri: 'projects\/{project}\/details',
            methods: ['PUT', 'PATCH'],
            parameters: ['project'],
            bindings: { project: 'id' },
        },
        'finance.global': { uri: 'finance', methods: ['GET', 'HEAD'] },
        'finance.index': {
            uri: 'finance\/projects\/{project}',
            methods: ['GET', 'HEAD'],
            parameters: ['project'],
            bindings: { project: 'id' },
        },
        'finance.storeIncome': {
            uri: 'finance\/projects\/{project}\/income',
            methods: ['POST'],
            parameters: ['project'],
            bindings: { project: 'id' },
        },
        'finance.storeExpense': {
            uri: 'finance\/projects\/{project}\/expense',
            methods: ['POST'],
            parameters: ['project'],
            bindings: { project: 'id' },
        },
        'finance.destroyIncome': {
            uri: 'finance\/projects\/{project}\/income\/{income}',
            methods: ['DELETE'],
            parameters: ['project', 'income'],
            bindings: { project: 'id', income: 'id' },
        },
        'finance.destroyExpense': {
            uri: 'finance\/projects\/{project}\/expense\/{expense}',
            methods: ['DELETE'],
            parameters: ['project', 'expense'],
            bindings: { project: 'id', expense: 'id' },
        },
        'general-expense.index': {
            uri: 'finance\/general',
            methods: ['GET', 'HEAD'],
        },
        'general-expense.store': { uri: 'finance\/general', methods: ['POST'] },
        'general-expense.destroy': {
            uri: 'finance\/general\/{generalExpense}',
            methods: ['DELETE'],
            parameters: ['generalExpense'],
            bindings: { generalExpense: 'id' },
        },
        'role-workflows.index': {
            uri: 'role-workflows',
            methods: ['GET', 'HEAD'],
        },
        'role-workflows.create': {
            uri: 'role-workflows\/create',
            methods: ['GET', 'HEAD'],
        },
        'role-workflows.store': { uri: 'role-workflows', methods: ['POST'] },
        'role-workflows.edit': {
            uri: 'role-workflows\/{id}\/edit',
            methods: ['GET', 'HEAD'],
            parameters: ['id'],
        },
        'role-workflows.update': {
            uri: 'role-workflows\/{id}',
            methods: ['PUT'],
            parameters: ['id'],
        },
        'role-workflows.destroy': {
            uri: 'role-workflows\/{id}',
            methods: ['DELETE'],
            parameters: ['id'],
        },
        'role-responsibilities.index': {
            uri: 'role-responsibilities',
            methods: ['GET', 'HEAD'],
        },
        'role-responsibilities.create': {
            uri: 'role-responsibilities\/create',
            methods: ['GET', 'HEAD'],
        },
        'role-responsibilities.store': {
            uri: 'role-responsibilities',
            methods: ['POST'],
        },
        'role-responsibilities.edit': {
            uri: 'role-responsibilities\/{id}\/edit',
            methods: ['GET', 'HEAD'],
            parameters: ['id'],
        },
        'role-responsibilities.update': {
            uri: 'role-responsibilities\/{id}',
            methods: ['PUT'],
            parameters: ['id'],
        },
        'role-responsibilities.destroy': {
            uri: 'role-responsibilities\/{id}',
            methods: ['DELETE'],
            parameters: ['id'],
        },
